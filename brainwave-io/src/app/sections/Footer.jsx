export default function Footer() {
    ...
    return (
        <footer className="">
            ...
            <div className="text-white font-light flex justify-between py-40 tracking-wider">
                {siteMap.map((sec, index)=> (
                    <ul className="space-y-4" key={`footer_section_${index}`}>
                        <h4 className="opacity-60">{sec.section }</h4>
                        {sec.pages.map((page, idx) => (
                            <li key={`footer_section_list_item_${index}`} className="">{page}</li>
                        ))}
                    </ul>
                    
                ))}
                <ul className="space-y-4">
                    <h4 className="opacity-60">Contact Us</h4>
                    <li>
            ...
            <div className="text-white text-xs flex justify-between py-4 font-light border-t-[0.5px] border-gray-500">
                <div>
                    <p className="opacity-60">© 2024 Copyright, All Rights Reserved, Made by Seju_ui_ux <span className="text-blue opacity-100">❤️</span></p>
                </div>
